  ...
  <table class="table table-hover" id="listtabel">
    ...
    ?>
      <tr>
        ...
        <td>
          <a href="edit-angkatan.php?id=<?php echo $id; ?>" class="btn btn-success">Edit Data</a>
          <a href="hapus-angkatan.php?id=<?php echo $id; ?>" class="btn btn-danger">Hapus Data</a>
        </td>
      </tr> 
    <?php 
      }
